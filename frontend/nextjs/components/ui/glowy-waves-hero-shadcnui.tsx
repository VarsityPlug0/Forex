...
const heroStats: { label: string; value: string }[] = [
  ...
  { label: "Trades Analysed", value: "50K+" },
]
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 -z-10 pointer-events-none">
        ...
        <div className="absolute top-1/2 left-1/4 h-[400px] w-[400px] rounded-full bg-primary/[0.04] blur-[150px]" />
      </div>
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-6xl flex-col items-center px-6 py-24 text-center md:px-8 lg:px-12">
        ...
        >
          ...
          >
            ...
            Professional Forex Trading Community
          </motion.div>
          ...
          >
            Join 2,400+ traders learning Supply &amp; Demand, Order Flow, and
            Smart Money concepts — then put it to work in our transparent PAMM
            investment groups.
          </motion.p>
